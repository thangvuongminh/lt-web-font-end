...
const Payout = () => {
  ...
  const fee = useMemo(() => Math.round(amount * feeRate), [amount]);
  ...
  const handleSubmit = () => {
    ...
    setAlert("Yêu cầu rút tiền đã được ghi nhận. Vui lòng xác nhận để tiếp tục.");
    setStep(2);
  };
          ...
          <div className="flex flex-wrap items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-lg font-semibold">Xác nhận</p>
              </div>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 flex items-center justify-center rounded-none bg-gray-100 text-gray-600 font-semibold">3</div>
              <div>
                <p className="text-sm text-gray-500 uppercase">Bước 3</p>
            ...
            <div className="space-y-6">
              <div className="rounded-none border border-gray-200 bg-white p-6 shadow-sm">
                ...
                <div className="mt-6 space-y-4 text-sm text-gray-600">
                  ...
                  <div className="flex justify-between">
                    <span>Phí dịch vụ ({feeRate * 100}%)</span>
                    <span>{amount ? formatCurrency(fee) : "---"}</span>
                  </div>
              ...
              <div className="rounded-none border border-gray-200 bg-white p-6 shadow-sm">
                ...
                <div className="mt-5 grid gap-3">
                  ...
                  <div className={`rounded-none p-4 ${step === 2 ? "bg-[#E93C60]/10 text-[#841c36]" : "bg-gray-100 text-gray-700"}`}>
                    ...
                    <p className="text-sm">Xác nhận thông tin</p>
                  </div>
                  <div className={`rounded-none p-4 ${step === 3 ? "bg-[#E93C60]/10 text-[#841c36]" : "bg-gray-100 text-gray-700"}`}>
